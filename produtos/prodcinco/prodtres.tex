...
\end{figure}
	...
	\subsection{Resíduo Sólido Comum}\label{rsc_ml}
...
\end{figure}
	...
	\input{./produtos/prodtres/coleta_brasil}
...
%o uso do parênteses na atribuição do rótulo coloca a numeração da	lista entre parênteses. Se não usado, não exibe parênteses		
	...
	\input{./produtos/prodtres/classe_rss}
	...
	\input{./produtos/prodtres/cultivos_upas}
	...
	\input{./produtos/prodtres/manejo_rcc}
...
\end{itemize}
	...
	\input{./produtos/prodtres/destinacao_gasto}
	...
	\input{./produtos/prodtres/gasto_reciclavel}
...
\end{itemize}
	...
	\input{./produtos/prodtres/oficinas}
