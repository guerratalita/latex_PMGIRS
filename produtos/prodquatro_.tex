...
\input{./produtos/prodquatro/municipios_codivap}
\FloatBarrier
...
A \autoref{tab:capacit_tec} apresenta os Programas e Ações recomendados ao município de Monteiro Lobato, referente a sua capacitação técnica, seu respectivo público-alvo, modo e frequência de implementação.
	...
	\input{./produtos/prodquatro/capacit_tec}
...
%\textbf{\underline{Para que o município consiga atingir as metas para ..... gestão, seguir os indicadores já propostos no Produto 3. Essas metas são.....}}
	...
	\input{./produtos/prodquatro/grav_comum_media}
...
A \autoref{tab:grav_seletiva_media}
	...
	\input{./produtos/prodquatro/grav_seletiva_media}
...
\input{./produtos/prodquatro/limites_coleta_seletiva}
...
\input{./produtos/prodquatro/limites_log_reversa}
...
\input{./produtos/prodquatro/acoes_prevent}
\FloatBarrier
...
\input{./produtos/prodquatro/acoes_emerg_cont}
