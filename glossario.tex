...
\newacronym{att}{ATT}{Área de Transbordo e Triagem}

\newacronym{cdm}{CDM}{Centro de Desenvolvimento Municipal}
\newacronym{cnm}{CNM}{Confederação Nacional de Municípios}
...
\newacronym{codivap}{CODIVAP}{Consórcio de Desenvolvimento Integrado do Vale do Paraíba}
...
\newacronym{ea}{EA}{Educação Ambiental}
...
\newacronym{lev}{LEV}{Locais de Entrega Voluntária}
